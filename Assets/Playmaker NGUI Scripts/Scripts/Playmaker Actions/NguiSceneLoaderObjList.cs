...
public class NguiSceneLoaderObjList : FsmStateAction
{
    ...
    /// </summary>
    private LoaderInfo CurrentLoaderGO = null;
    ...
    /// </summary>
    private bool SetParentInactive = false;

    /// <summary>
    /// When true, the current GO will be set inactive after it is loaded.
    /// </summary>
    private bool SetToInactive = false;

    /// <summary>
    /// Used to increment the progress bar
    /// </summary>
    private float ProgressStepValue = 0;
    ...
    /// </summary>
    private float TimeToLoadNextObject = 0;
